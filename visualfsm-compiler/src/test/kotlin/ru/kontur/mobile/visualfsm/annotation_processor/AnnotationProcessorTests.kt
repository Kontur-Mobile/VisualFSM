...
internal class AnnotationProcessorTests {
    ...
    fun testBaseActionWithSealedClass() {
        val testFSMSource = SourceFile.kotlin(
            ...
            contents = """
                ...
                class TestAction1(val parameter1: String): TestAction() {
                    ...
                    inner class Transition3: ManyToManySealedTransition<TestState.TestNavigation, TestState.TestState1>() {
        ...
        Assertions.assertEquals(
            "import kotlin.Suppress\n" +
                ...
                "                _fromState = TestState.TestNavigation.NavigateToExit::class as kotlin.reflect.KClass<TestState.TestNavigation>\n" +
                "                _toState = TestState.TestState1::class\n" +
                "            },\n" +
                "            action.Transition3().apply {\n" +
                "                _fromState = TestState.TestNavigation.NavigateToNext::class as kotlin.reflect.KClass<TestState.TestNavigation>\n" +
                "                _toState = TestState.TestState1::class\n" +
                "            },\n" +
                "        )\n" +
                "\n" +
    ...
    @Test
    fun testBaseActionWithOneToOneSealedClassStrategy() {
        val testFSMSource = SourceFile.kotlin(
            name = "Test.kt",
            contents = """
                import ru.kontur.mobile.visualfsm.*
                ...
                sealed class TestState: State {
                    ...
                    sealed class SealedClassState: TestState(){
                        data object SealedState1: SealedClassState()
                        data object SealedState2: SealedClassState()
                    }
                }
                ...
                class TestAction1(val parameter1: String): TestAction() {
                    ...
                    inner class Transition2: OneToOneSealedTransition<TestState.SealedClassState, TestState.SealedClassState>() {
                        override fun transform(state: TestState.SealedClassState): TestState.SealedClassState = state
                    }
                }
        ...
        Assertions.assertEquals(
            "import kotlin.Suppress\n" +
                ...
                "            },\n" +
                "            action.Transition2().apply {\n" +
                "                _fromState = TestState.SealedClassState.SealedState1::class as kotlin.reflect.KClass<TestState.SealedClassState>\n" +
                "                _toState = TestState.SealedClassState.SealedState1::class as kotlin.reflect.KClass<TestState.SealedClassState>\n" +
                "            },\n" +
                "            action.Transition2().apply {\n" +
                "                _fromState = TestState.SealedClassState.SealedState2::class as kotlin.reflect.KClass<TestState.SealedClassState>\n" +
                "                _toState = TestState.SealedClassState.SealedState2::class as kotlin.reflect.KClass<TestState.SealedClassState>\n" +
                "            },\n" +
                "        )\n" +
                "\n" +
                "        else -> error(\"Code generation error. Not all actions were processed in the when block.\")\n" +
    ...
    @Test
    fun testBaseActionWitManyToManySealedClassStrategyWithTwoSealed() {
        val testFSMSource = SourceFile.kotlin(
            name = "Test.kt",
            contents = """
                import ru.kontur.mobile.visualfsm.*
                ...
                class TestAction1(val parameter1: String): TestAction() {
                    ...
                    inner class Transition2: ManyToManySealedTransition<TestState.SealedClassState, TestState.SealedClassState>() {
                        override fun transform(state: TestState.SealedClassState): TestState.SealedClassState = state
                    }
                }
