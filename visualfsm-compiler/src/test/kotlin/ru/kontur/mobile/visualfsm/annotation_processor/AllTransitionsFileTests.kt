...
internal class AllTransitionsFileTests {
        ...
        val testFSMSource = SourceFile.kotlin(
            ...
            contents = """
                ...
                class TestAction1(val parameter1: String): TestAction() {
                    ...
                    inner class Transition1: ManyToManySealedTransition<TestState.TestNavigation, TestState.TestState1>() {
    ...
    @Test
    fun testTransitionsWithSealedClassInFromStateAndToStateFileManyToManyStrategy() {
        val testFSMSource = SourceFile.kotlin(
            name = "Test.kt",
            contents = """
                import ru.kontur.mobile.visualfsm.*
                ...
                class TestAction1(val parameter1: String): TestAction() {
                    ...
                    inner class Transition1: ManyToManySealedTransition<TestState.SealedTest1, TestState.SealedTest1>() {
                        override fun transform(state: TestState.SealedTest1): TestState.SealedTest1 = state
                    }

                    inner class Transition2: ManyToManySealedTransition<TestState.SealedTest1, TestState.TestState1>() {
    ...
    @Test
    fun testTransitionsWithSealedClassInFromStateAndToStateFileOneToOneStrategy() {
        val testFSMSource = SourceFile.kotlin(
            name = "Test.kt",
            contents = """
                import ru.kontur.mobile.visualfsm.*
                ...
                class TestAction1(val parameter1: String): TestAction() {
                    ...
                    inner class Transition1: OneToOneSealedTransition<TestState.SealedTest1, TestState.SealedTest1>() {
                        override fun transform(state: TestState.SealedTest1): TestState.SealedTest1 = state
                    }
