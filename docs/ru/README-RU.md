...
- `VisualFSM.generateDigraph(...): String` - сгенерировать граф в DOT формате для визуализации в Graphviz (graphviz cli для CI или http://www.webgraphviz.com/ локально), используйте аргумент useTransitionName для подстановки имени Transition или Action класса в качестве имени ребра или аннотацию @Edge("name") для Transition класса чтобы установить произвольное имя ребра
