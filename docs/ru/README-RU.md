...
- `VisualFSM.generateDigraph(...): String` - генерация графа в DOT формате для визуализации в Graphviz, используйте аргумент useTransitionName для подстановки имени Transition или Action класса в качестве имени ребра или аннотацию @Edge("") для установки имени
